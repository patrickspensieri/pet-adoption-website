    ...
    <body onload = "refreshDate();">
        ...
        <div class = "sideMenu">
            <ul>
                ...
                <li id = "active"> <a href = "dogCare.php">Dog Care</a></li>
        ...
        <div class = "content-center">
            <h2 class = "label">Dog Care</h2>
            <h3 class = "label">courtesy of <i>Bree Bacon</i></h3>
            <hr>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/QqCyvLR8TfQ" 
