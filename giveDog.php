...
<!--    giveDog.html
        ...
        Assignment 2 : Question 4
            Give away a dog page.
     -->

<html xlms = "http://www.w3.org/1999/xhtml" lang = "en">
    <head>
        <meta charset = "utf-8" />
        <title>Give Away a Dog : 40006417</title>
    ...
    <body onload = "refreshDate();">
        ...
        <div class = "content">
            ...
            if(isset($_POST['submitBtn']))
            {
                ...
                $entry = $_SESSION['int'] .":". $_SESSION['username'] .':dog:'. $_POST['age'].":". $_POST['gender'].":" . $_POST['petFriendly'].':'. $_POST['about'] .':'. $_POST['firstName'].':'. $_POST['lastName'].':'. $_POST['email']. "\n";
                fwrite ($file, $entry);
                fclose ($file);
            ...
            <form id = "form" method="post">
                 <h1 class = "label">Give Away a Dog</h1>
                 <hr>
                    <h2 class = "label">Breed </h2>
                    <select class = "single" name = "breed">
                                <option selected = "selected"> Miniature Schnauzer </option>
                 ...
                 <h2 class = "label">Tell Us About Your Dog</h2>
                 <textarea name = "about" placeholder = "Why are you putting your Dog up for adoption?"></textarea>
                 ...
                 <label><h2 class = "label">Your dog will find a great new home!</h2>
